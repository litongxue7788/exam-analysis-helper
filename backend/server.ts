...
import { USER_PROMPT_TEMPLATE } from './llm/prompts';
import { llmService } from './llm/service'; // 引入真实的 LLM 服务
...
`;
    ...
    let reportJson: any;
    try {
        const rawContent = await llmService.generateImageAnalysis(images, visionPrompt, config);
